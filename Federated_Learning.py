...
print(f"Hospital A: {len(client_a)}, Hospital B: {len(client_b)}, Hospital C: {len(client_c)}")
...
# -------------------------
# Step 3.6: Federated training rounds
# -------------------------
